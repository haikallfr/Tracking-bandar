...
function next_day_profile_meta(string $profile): array
{
    ...
    return match ($profile) {
        ...
        'fast_v3' => [
            'profile' => 'fast_v3',
            'label' => 'Fast V3',
            'latest_file' => (string) setting('next_day_fast_v3_dataset_latest_file', ''),
            'generated_at' => (string) setting('next_day_fast_v3_dataset_latest_generated_at', ''),
            'count' => (int) setting('next_day_fast_v3_dataset_latest_count', '0'),
        ],
        'fast_v4' => [
            'profile' => 'fast_v4',
            'label' => 'Fast V4',
            'latest_file' => (string) setting('next_day_fast_v4_dataset_latest_file', ''),
            'generated_at' => (string) setting('next_day_fast_v4_dataset_latest_generated_at', ''),
            'count' => (int) setting('next_day_fast_v4_dataset_latest_count', '0'),
        ],
        'fast_v5' => [
            'profile' => 'fast_v5',
            'label' => 'Fast V5',
            'latest_file' => (string) setting('next_day_fast_v5_dataset_latest_file', ''),
            'generated_at' => (string) setting('next_day_fast_v5_dataset_latest_generated_at', ''),
            'count' => (int) setting('next_day_fast_v5_dataset_latest_count', '0'),
        ],
        'fast_v6' => [
            'profile' => 'fast_v6',
            'label' => 'Fast V6',
            'latest_file' => (string) setting('next_day_fast_v6_dataset_latest_file', ''),
            'generated_at' => (string) setting('next_day_fast_v6_dataset_latest_generated_at', ''),
            'count' => (int) setting('next_day_fast_v6_dataset_latest_count', '0'),
        ],
        'fast_v7' => [
            'profile' => 'fast_v7',
            'label' => 'Fast V7',
            'latest_file' => (string) setting('next_day_fast_v7_dataset_latest_file', ''),
            'generated_at' => (string) setting('next_day_fast_v7_dataset_latest_generated_at', ''),
            'count' => (int) setting('next_day_fast_v7_dataset_latest_count', '0'),
        ],
        default => [
            'profile' => 'swing',
            'label' => 'Swing',
...
function next_day_payload(string $profile = 'swing'): array
{
    ...
    return [
        ...
        'profiles' => $meta['rules'] ?? [
            ...
            'fast_v3' => NextDayFilter::rules('fast_v3'),
            'fast_v4' => NextDayFilter::rules('fast_v4'),
            'fast_v5' => NextDayFilter::rules('fast_v5'),
            'fast_v6' => NextDayFilter::rules('fast_v6'),
            'fast_v7' => NextDayFilter::rules('fast_v7'),
        ],
        'radar' => [
            'generated_at' => $profileMeta['generated_at'],
            'count' => count($items),
